...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            l = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",
                f ? Qa(i, f) : i).on("mouseup", function() { setTimeout(function() { i.call(l[0]) }, 10) }).on("keypress.DT", function(a) { if (13 == a.keyCode) return !1 }).attr("aria-controls", c);
        h(a.nTable).on("search.dt.DT", function(b, c) { if (a === c) try { l[0] !== H.activeElement && l.val(e.sSearch) } catch (d) {} });
        return b[0]
    }
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            I(function(a, b) { if (h.inArray(a, Zb) !== -1) a.style.width = v[b] },
                o);
            h(L).height(0);
    ...
    function Ha(a) {
        ...
        if (d || !u && !f && !e && j == W(a) && j == l.length)
            ...
            o = h("<div/>").css(f ||
                e ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {}).append(j).appendTo(k);
    ...
    function Ib(a, b) { for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++) c = B(a, f, b, "display") + "", c = c.replace($b, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f); return e }
        ...
        if ("ssp" != y(a) && 0 !== h.length) {
            ...
            g === h.length ? i.sort(function(a, b) {
                var c, e, g, j, i = h.length,
                    ...
                    n = f[b]._aSortData;
                for (g = 0; g < i; g++)
                    if (j = h[g], c = k[j.col], e = n[j.col], c = c < e ? -1 : c > e ? 1 : 0, 0 !== c) return "asc" ===
                        j.dir ? c : -c;
                c = d[a];
                e = d[b];
    ...
    function Jb(a, b) {
        ...
        for (var f, g = n.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++)
            if (c = a.aoData[j], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f =
    ...
    var n = function(a) {
            ...
            this.each(function() {
                var e = {},
                    ...
                    q = h(this);
                if ("table" !=
                    this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                else {
                    gb(m);
                    hb(m.column);
                    J(m, m, !0);
                    ...
                    for (i = u.length; j < i; j++) {
                        ...
                        if (o.nTable == this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) {
                            ...
                            if (g.bDestroy !== k ? g.bDestroy : m.bDestroy) { o.oInstance.fnDestroy(); break } else {
    ...
    n.util = {
        ...
        escapeRegex: function(a) { return a.replace(bc, "\\$1") }
    };
    ...
    var Ub = function(a, b) {
        ...
        return h(c).filter(a).map(function() { var a = h.inArray(this, c); return b[a] }).toArray()
    };
    o("tables()", function(a) { return a !== k && null !== a ? new r(Ub(a, this.context)) : this });
    o("table()", function(a) {
        var a = this.tables(a),
            b = a.context;
    ...
    o("page.len()", function(a) { return a === k ? 0 !== this.context.length ? this.context[0]._iDisplayLength : k : this.iterator("table", function(b) { Ta(b, a) }) });
    ...
    o("ajax.reload()", function(a, b) { return this.iterator("table", function(c) { Vb(c, !1 === b, a) }) });
            ...
            if (c.length && a.length) {
                ...
                if (d._details) {
                    ...
                    0 < C(g, "_details").length && (f.on("draw.dt.DT_details", function(a, b) {
                        ...
                        if (e ===
                            b)
                            for (var c, d = W(b), f = 0, h = g.length; f < h; f++) c = g[f], c._details && c._details.children("td[colspan]").attr("colspan", d)
    ...
    o(["row().child.show()", "row().child().show()"], function() { Wb(this, !0); return this });
    o(["row().child.hide()", "row().child().hide()"], function() { Wb(this, !1); return this });
    o(["row().child.remove()",
        "row().child().remove()"
    ...
    s("columns().data()", "column().data()", function() { return this.iterator("column-rows", Xb, 1) });
    ...
    o("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            c = h.inArray(b, n.settings); - 1 !== c && n.settings.splice(c,
                1)
        })
    });
                    ...
                    o = function(b, d) {
                        ...
                        for (s = d.length; k <
                            ...
                            if (h.isArray(t)) {
                                ...
                                if (l !== null) {
                                    r = h("<a>", { "class": g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[t], "data-dt-idx": n, tabindex: r, id: c === 0 && typeof t === "string" ? a.sTableId + "_" + t : null }).html(l).appendTo(b);
                                    Xa(r, { action: t }, w);
                                    n++
                                }
                            }
    ...
    }, function(a, b) { var c = b.oLanguage.sDecimal; return ab(a, c, !0) ? "num-fmt" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c) ? "html-num" + c : null }, function(a, b) { var c = b.oLanguage.sDecimal; return Rb(a, c, !0) ? "html-num-fmt" + c : null }, function(a) { return M(a) || "string" === typeof a && -1 !== a.indexOf("<") ? "html" : null }]);
